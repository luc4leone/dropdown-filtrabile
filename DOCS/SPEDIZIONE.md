...
- [x] potrebbe essere utile aiuto AI in personalizzazione email `solo in excalidraw`
...
- [ ] Notifica: quando un indirizzo non valido viene aggiornato dalla redazione, notificare Account che hanno fatto spedizioni con indirizzo non valido (da Regina)
